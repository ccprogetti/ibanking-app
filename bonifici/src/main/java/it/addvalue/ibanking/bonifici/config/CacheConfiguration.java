...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, it.addvalue.ibanking.bonifici.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.addvalue.ibanking.bonifici.repository.UserRepository.USERS_BY_EMAIL_CACHE);
