  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.conto.home.createOrEditLabel" data-cy="ContoCreateUpdateHeading">
            <Translate contentKey="gatewayApp.conto.home.createOrEditLabel">Create or edit a Conto</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.conto.nome')}
                id="conto-nome"
                name="nome"
                data-cy="nome"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.conto.iban')}
                id="conto-iban"
                name="iban"
                data-cy="iban"
                type="text"
