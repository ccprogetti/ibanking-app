...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './conto.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IConto, defaultValue } from 'app/shared/model/conto.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTO actions', async () => {
      const expectedActions = [
        {
