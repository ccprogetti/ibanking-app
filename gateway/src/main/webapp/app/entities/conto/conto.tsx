...
import { IConto } from 'app/shared/model/conto.model';
  ...
  return (
    <div>
      <h2 id="conto-heading" data-cy="ContoHeading">
        <Translate contentKey="gatewayApp.conto.home.title">Contos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.conto.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.conto.home.createLabel">Create new Conto</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contoList && contoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.conto.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.conto.nome">Nome</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.conto.iban">Iban</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.conto.home.notFound">No Contos found</Translate>
            </div>
          )
        )}
      </div>
