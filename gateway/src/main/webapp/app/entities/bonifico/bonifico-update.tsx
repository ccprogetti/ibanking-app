  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.bonifico.home.createOrEditLabel" data-cy="BonificoCreateUpdateHeading">
            <Translate contentKey="gatewayApp.bonifico.home.createOrEditLabel">Create or edit a Bonifico</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.bonifico.causale')}
                id="bonifico-causale"
                name="causale"
                data-cy="causale"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.bonifico.destinatario')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.bonifico.importo')}
                id="bonifico-importo"
                name="importo"
                data-cy="importo"
                type="text"
              />
              <ValidatedField
                label={translate('gatewayApp.bonifico.dataEsecuzione')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.bonifico.ibanDestinatario')}
