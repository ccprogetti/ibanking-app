...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bonifico.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IBonifico, defaultValue } from 'app/shared/model/bonifico.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONIFICO_LIST actions', async () => {
    ...
    it('dispatches FETCH_BONIFICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BONIFICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BONIFICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BONIFICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BONIFICO actions', async () => {
      const expectedActions = [
        {
