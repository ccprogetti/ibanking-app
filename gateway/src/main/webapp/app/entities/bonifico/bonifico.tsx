...
import { IBonifico } from 'app/shared/model/bonifico.model';
  ...
  return (
    <div>
      <h2 id="bonifico-heading" data-cy="BonificoHeading">
        <Translate contentKey="gatewayApp.bonifico.home.title">Bonificos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.bonifico.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.bonifico.home.createLabel">Create new Bonifico</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bonificoList && bonificoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.bonifico.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.bonifico.causale">Causale</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.bonifico.destinatario">Destinatario</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.bonifico.importo">Importo</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.bonifico.dataEsecuzione">Data Esecuzione</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.bonifico.ibanDestinatario">Iban Destinatario</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.bonifico.home.notFound">No Bonificos found</Translate>
            </div>
          )
        )}
      </div>
