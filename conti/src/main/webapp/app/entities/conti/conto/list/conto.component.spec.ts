...
describe('Conto Management Component', () => {
  let comp: ContoComponent;
  let fixture: ComponentFixture<ContoComponent>;
  let service: ContoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'conti/conto', component: ContoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ContoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
